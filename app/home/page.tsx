        ...
        <div className='flex flex-col items-center justify-center min-h-screen py bg-gray-100'>
            ...
            <main className='flex flex-col items-center justify-center w-full flex-1 px-20 text-center'>
                <div className='bg-white rounded-2xl shadow-2xl flex w-2/3 max-w-4xl'>
                    ...
                    <p className='mb-2'> like ur autocomplete, what do u use that autocomplete in vs code 
                    Very appreciate it, if u wanna tell me about that. Thanks in advance</p>
                    <a href="#" className='border-2 border-white rounded-full px-12 py-2 inline-block font-semibold hover:bg-white
                     hover:text-blue-500'>Registrar</a>
                    </div>
                </div>
            </main>
        </div>
